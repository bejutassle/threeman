...
use Validation\MissingRequiredParameterException;
...
abstract class Rule
{
     ...
     * Set attribute
     *
     * @param Validation\Attribute $attribute
     * @return void
     */
     ...
     * @param array $params
     * @return void
     * @throws Validation\MissingRequiredParameterException
     */
