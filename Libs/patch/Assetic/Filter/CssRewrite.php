 ...
 */
class CssRewrite extends BaseCssFilter
{
    ...
    public function filterDump(AssetInterface $asset)
    {
        ...
        if (false !== strpos($sourceBase, '://')) {
            ...
            if(filter_var($sourceDir, FILTER_VALIDATE_URL)) {
            list($scheme, $url) = explode('://', $sourceDir.'/'.$sourcePath, 2);
